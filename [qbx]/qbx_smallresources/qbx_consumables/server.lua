...
exports.qbx_core:CreateUseableItem('box-44', function(source, item)
    local success = lib.callback.await('qbx_consumables:openAmmoBox',source)
    if success then
        exports.ox_inventory:AddItem(source, 'ammo-45', 100)
        exports.ox_inventory:RemoveItem(source, 'box-44', 1)
    end
end)
