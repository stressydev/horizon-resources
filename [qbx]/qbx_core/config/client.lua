return {
    statusIntervalSeconds = 3.5, -- how often to check hunger/thirst status to remove health if 0.
    loadingModelsTimeout = 30000, -- Waiting time for ox_lib to load the models before throws an error, for low specs pc

    pauseMapText = 'Powered by Horizon Developers', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
    ...
    discord = {
        ...
        appId = '1446242891524608050', -- This is the Application ID (Replace this with you own)

        largeIcon = { -- To set this up, visit https://forum.cfx.re/t/how-to-updated-discord-rich-presence-custom-image/157686
            icon = 'hcr_logo', -- Here you will have to put the image name for the 'large' icon.
            text = 'Horizon RP', -- Here you can add hover text for the 'large' icon.
        },

        smallIcon = {
            icon = 'hcr_logo', -- Here you will have to put the image name for the 'small' icon.
            text = 'Whut?', -- Here you can add hover text for the 'small' icon.
        },

        firstButton = {
            text = 'Horizon RP Discord',
            link = 'https://discord.gg/cdM8dfaVHr',
        },
