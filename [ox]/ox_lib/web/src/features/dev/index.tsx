      ...
      <Drawer position="left" onClose={() => setOpened(false)} opened={opened} title="Developer drawer" padding="xl">
        <Stack>
          ...
          <Button fullWidth onClick={() => {
            debugAlert();
            setTimeout(() => debugInput(), 500);
            setTimeout(() => debugContext(), 1000);
            setTimeout(() => debugMenu(), 1500);
            setTimeout(() => debugCustomNotification(), 2000);
          }} color="green">
            🎨 Test All Components (Sequential)
          </Button>
          ...
          <Divider label="Individual Tests" />
